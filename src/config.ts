...
export const siteConfig: SiteConfig = {
	...
	bangumi: {
		userId: "842198", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				"僕の目、ひとつあげましよう，だからあなたの目をください",
				"以和为贵",
				"我不是萝莉控，只是喜欢的女孩子刚好是萝莉而已",
				"今でもあなたは私の光",
				"時よ過ぎゆけ、おまえは残酷だ，時よ止まれ、お前は美しい",
				"鬼を逢うては鬼は斬る、仏を逢うては仏は斬る、剣胄の理、ここにあり",
			],
			typewriter: {
...
export const profileConfig: ProfileConfig = {
	avatar: "/images/mia.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Autumnbutterfly",
	bio: "教えて、君の宇宙について",
	typewriter: {
